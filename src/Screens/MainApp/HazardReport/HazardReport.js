    ...
    renderRow(item) {
        ...
        return (
            <View key={'item-'+item.id} style={styles.rowContainer}>
                    ...
                    <View style={styles.tableBodySeparator} />
                    <View style={styles.bodyTable}>
                        <Text style={styles.fontBodyStyle}>Hazard Type</Text>
                    </View>
                    <View style={styles.tableBodySeparator} />
                    <View style={styles.bodyTable}>
                    ...
                    <View style={styles.tableContainer}>
                        <View style={styles.tableHeadContainer}>
                            <View style={styles.headerTable}>
                                <Text style={styles.fontStyle}>Hazard Date</Text>
                            </View>
                            ...
                            <View style={styles.tableHeadSeparator} />
                            <View style={styles.headerTable}>
                                <Text style={styles.fontStyle}>Hazard Type</Text>
                            </View> 
                            <View style={styles.tableHeadSeparator} />
                            <View style={styles.headerTable}>
                        ...
                        {this.state.ListDataHazard.length == 0 ?
                            <View style={styles.containerTidakAdaData}>
                                <Text>No Data</Text>
                            </View>
                            :
                            this.state.ListDataHazard.map((item) => { 
