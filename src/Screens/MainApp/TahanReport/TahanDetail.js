...
export class TahanDetail extends Component {
    constructor(props){
        super(props);
        this.state = {
            ModalVisible: false,
                    ...
                    <View style={styles.contentContainer}>
                        <View style={styles.containerCard}>
                            ...
                            <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                                ...
                                <View>
                                    <Text style={[styles.contentIncident, {fontWeight: 'bold', marginTop: 10}]}>TAHAN Type</Text>
                                    <Text style={[styles.contentIncident]}>Unsafe Condition</Text>
                                </View>
                            </View>
                            <Text style={[styles.contentIncident, {fontWeight: 'bold', marginTop: 15}]}>TAHAN Category </Text>
                            <Text>Energy sources (Hydraulic, Pneumatic, Mechanical etc)</Text>
                            <View style={{height: 1, backgroundColor: '#dbdbdb', marginTop: 10}}/>
                            <Text style={[styles.contentIncident, {fontWeight: 'bold', marginTop: 10}]}>Detail of TAHAN</Text>
